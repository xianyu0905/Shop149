                            ...
                            <div class="panel-body">
                                <div class="art-back clear-back">
                                    <div class="add-padding-bottom">
                                       <img src="${pageContext.request.contextPath}/front/product/images${product.image}" class="shopImg">
                                          <%-- <img src="ftp://ftptest:Zhu0905..@116.62.244.46/static/images/20200209/${product.image}" class="shopImg">--%>
                                    </div>
                                    <h4 class="myH4"><a href="#">${product.name}</a></h4>

                                    <div class="user clearfix pull-right"><span>¥ </span>${product.price}</div>
                                    <div> <span>库存:${product.inventory}&nbsp;&nbsp;</span></div>
                                    <div>
