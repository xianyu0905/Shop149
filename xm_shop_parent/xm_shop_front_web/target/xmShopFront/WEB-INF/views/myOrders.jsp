            ...
            <table class="table table-hover orderDetail">
                ...
                <c:forEach items="${orderVoList}" var="orderVo">
                    ...
                    <c:forEach items="${orderVo.orderItemList}" var="orderItem">
                        <tr>
                            <td class="col-sm-1">
                                <img src="${pageContext.request.contextPath}/front/product/images${orderItem.product.image}" alt="" style="cursor: pointer" onclick="showProductFromOrder(${orderItem.product.id})">
                            </td>
