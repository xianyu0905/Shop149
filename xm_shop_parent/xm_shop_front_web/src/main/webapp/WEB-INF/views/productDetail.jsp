...
<div class="row" style="margin-top: 50px">
    <div class="container">
        <div class="col-sm-6" style="padding: 0">
            <div class="imgShow">
                <img style="width: 400px;height: 400px" src="${pageContext.request.contextPath}/front/product/images${product.image}" alt="">
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="cartCount">
                ...
                <span class="Hgt">库存(<span id="inventory">${product.inventory-1}</span>)</span>
            </div>
