            ...
            $.post(
                ...
                function (result) {
                    if (result.status == 1) {
                        ...
                        // $('#pro-image').val(result.data.image);
                        $('#pro-inventory').val(result.data.inventory);
                        $('#pro-TypeId').val(result.data.productType.id);
                        $('#img2').attr('src','${pageContext.request.contextPath}/admin/product/images'+result.data.image);
                    }
                }
            );
        }
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center row">
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="product-price" class="col-sm-4 control-label">库存：</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="product-inventory" name="inventory">
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center row">
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="pro-inventory" class="col-sm-4 control-label">库存：</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="pro-inventory" name="inventory">
                                    </div>
                                </div>
                                <div class="form-group">
