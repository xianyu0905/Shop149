...
public class ProductServiceImpl implements ProductService {
    ...
    public int addProduct(ProductDto productDto) throws FileUploadException {
        ...
        product.setImage("/" + timePath + "/" + fileName);
    ...
    @Override
    public InputStream downloadImage(String imageName, HttpServletResponse response) {
        return FtpUtils.getFile(host, port, username, password, basePath,  path+imageName, response);
    }
}
